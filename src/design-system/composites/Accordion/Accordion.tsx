  ...
  return (
    <div>
      <button
        ...
        disabled={disabled}
        onClick={toggle}
        className="flex w-full items-center gap-3 border-b border-border-subtle px-6 py-4 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary focus-visible:ring-inset disabled:opacity-40"
      >
        {leadingIcon}
